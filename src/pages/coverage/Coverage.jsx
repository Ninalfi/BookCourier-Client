...
const Coverage = () => {
  ...
  const handleSearch = e => {
    ...
    const district = covers.find(c => c.district.toLowerCase().includes(location.toLowerCase()));
    ...
    <div>
      <div className="p-14">
        ...
        <div className="border w-full h-200 mt-10">
            <h3 className="text-2xl mt-5 mb-5 font-bold">We deliver almost all over Bangladesh</h3>
          <MapContainer
            center={position}
            zoom={8}
